...
public class GoRESTApiNestedTodosTests {
    final static String elementType = "users";
    final static String elementTypeNested = "todos";
    ...
    void test1() {
        ...
        Logger.getLogger(GoRESTApiNestedTodosTests.class.getName()).log(Level.INFO,
