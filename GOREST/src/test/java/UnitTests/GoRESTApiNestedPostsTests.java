...
public class GoRESTApiNestedPostsTests {
    final static String elementType = "users";
    final static String elementTypeNested = "posts";
    ...
    void test1() {
        ...
        Logger.getLogger(GoRESTApiNestedPostsTests.class.getName()).log(Level.INFO,
